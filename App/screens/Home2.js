...
<View style={{flexDirection:'row',marginBottom:10}}>
      <TouchableOpacity onPress={() => navigation.push('Home')} style={styles.buttomHed}>
      <Text style={{fontWeight:'bold',padding:10,color:'#821151'}}> One way</Text>
    </TouchableOpacity>

    
    <Text style={{fontWeight:'bold',padding:10,borderWidth:1,borderRadius:30,color:'#821151'}}>Round Trip</Text>
    </View>
...
<Text style={{fontWeight:'bold',marginLeft:100}} >Return</Text>
</View>
<View style={{flexDirection:'row'}}>
       <DatePicker
      ...
      <Picker.Item label="Premium Ecommomy" value="pe" />
        ...
        <Picker.Item label="First" value="js" />
          ...
          {/* <View style={{ marginTop: 12 }}>
            <Text style={styles.inputText}>Passengers details</Text>
            <TextInput
              style={styles.textInput}
              placeholder="select passengers"
              onFocus={() => navigation.push("FlightSearch")}
              // value={`${adults} adults ${childrens} childrens ${x} rooms`}
            />
          </View> */}
